...
def get_products_df(wks_busca_info):
    ...
    products_df[['Altura', 'Largura', 'Comprimento', 'Peso']]   = products_df['Dimensões'].str.lower().str.extract(r'(\d+)x(\d+)x(\d+) - ([\d,]+)kg')
...
def connect_and_create_tiny(produto_info):
    ...
    api_key = 'a2cd8ea12fcd8ea1dff89bf9672e29ddad234376'
